...
Source0  : https://github.com/smuellerDD/libkcapi/archive/v1.5.0/libkcapi-1.5.0.tar.gz
...
%prep
%setup -q -n libkcapi-1.5.0
cd %{_builddir}/libkcapi-1.5.0
pushd ..
cp -a libkcapi-1.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705072513
...
/usr/share/man/man3/kcapi_md_sha3_224.3
/usr/share/man/man3/kcapi_md_sha3_256.3
/usr/share/man/man3/kcapi_md_sha3_384.3
/usr/share/man/man3/kcapi_md_sha3_512.3
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkcapi.so.1.5.0
/usr/lib64/libkcapi.so.1
/usr/lib64/libkcapi.so.1.5.0
