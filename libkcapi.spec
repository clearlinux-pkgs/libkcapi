...
Source0  : https://github.com/smuellerDD/libkcapi/archive/v1.3.0/libkcapi-1.3.0.tar.gz
...
%prep
%setup -q -n libkcapi-1.3.0
cd %{_builddir}/libkcapi-1.3.0
pushd ..
cp -a libkcapi-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621266243
...
cp %{_builddir}/libkcapi-1.3.0/COPYING.bsd %{buildroot}/usr/share/package-licenses/libkcapi/44a9f67b4a6876452742044723d955958f241b2c
cp %{_builddir}/libkcapi-1.3.0/COPYING.gplv2 %{buildroot}/usr/share/package-licenses/libkcapi/b47456e2c1f38c40346ff00db976a2badf36b5e3
pushd ../buildavx2/
%make_install_avx2
popd
%make_install
...
/usr/lib64/haswell/libkcapi.so.1.3.0
/usr/lib64/libkcapi.so.1
/usr/lib64/libkcapi.so.1.3.0
